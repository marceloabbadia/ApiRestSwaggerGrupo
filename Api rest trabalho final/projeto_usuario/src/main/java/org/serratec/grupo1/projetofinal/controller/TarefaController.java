...
public class TarefaController {
	...
	@GetMapping
	@Operation(summary = "Retornar tarefas", description = "Retorna todas as tarefas", tags = {
			"Tarefas" }, responses = { @ApiResponse(description = "Sucesso", responseCode = "200", content = {
					@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = TarefaResponseDto.class))) }),
	...
	@GetMapping("/{id}")
	@Operation(summary = "Buscar tarefa", description = "Busca uma tarefa", tags = { "Tarefas" }, responses = {
	...
	@PostMapping
	@Operation(summary = "Adicionar tarefa", description = "Adiciona uma nova tarefa", tags = {
			"Tarefas" }, responses = { @ApiResponse(description = "Sucesso", responseCode = "200", content = {
					@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = TarefaResponseDto.class))) }),
	...
	@PutMapping("/{id}")
	@Operation(summary = "Atualizar tarefa", description = "Atualiza dados de uma tarefa", tags = {
			"Tarefas" }, responses = { @ApiResponse(description = "Sucesso", responseCode = "200", content = {
					@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = TarefaResponseDto.class))) }),
					@ApiResponse(responseCode = "400", description = "Não autorizado"),
					@ApiResponse(responseCode = "401", description = "Proibido"),
	...
	@DeleteMapping("/{id}")
	@Operation(summary = "Deletar tarefa", description = "Deleta uma tarefa", tags = { "Tarefas" }, responses = {
			@ApiResponse(description = "Sucesso", responseCode = "200", content = {
					@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = TarefaResponseDto.class))) }),
			@ApiResponse(responseCode = "204", description = "Solicitação bem sucedida"),
			@ApiResponse(responseCode = "400", description = "Não autorizado"),
