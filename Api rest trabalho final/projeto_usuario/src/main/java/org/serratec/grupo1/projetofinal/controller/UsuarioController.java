...
public class UsuarioController {
	...
	@GetMapping
	@Operation(summary = "Retornar usuários", description = "Retorna todos os usuários", tags = {
			"Usuários" }, responses = { @ApiResponse(description = "Sucesso", responseCode = "200", content = {
	...
	@Operation(summary = "Buscar usuário e mostra suas tarefas ", description = "Busca um usuário e mostra suas tarefas ", tags = {
			"Usuário/Tarefa" }, responses = { @ApiResponse(description = "Sucesso", responseCode = "200", content = {
					@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = UsuarioResponseDto.class))) }),
	...
	@GetMapping("/{id}")
	@Operation(summary = "Buscar usuário", description = "Busca um usuário", tags = { "Usuários" }, responses = {
	...
	@PostMapping
	@Operation(summary = "Adicionar usuário", description = "Adiciona um novo usuário", tags = {
			"Usuários" }, responses = { @ApiResponse(description = "Sucesso", responseCode = "200", content = {
					@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = UsuarioResponseDto.class))) }),
	...
	@PutMapping("/{id}")
	@Operation(summary = "Atualizar usuário", description = "Atualiza dados de um usuário", tags = {
			"Usuários" }, responses = { @ApiResponse(description = "Sucesso", responseCode = "200", content = {
					@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = UsuarioResponseDto.class))) }),
					@ApiResponse(responseCode = "400", description = "Não autorizado"),
					@ApiResponse(responseCode = "401", description = "Proibido"),
	...
	@DeleteMapping("/{id}")
	@Operation(summary = "Deletar usuário", description = "Deleta um usuário", tags = { "Usuários" }, responses = {
			@ApiResponse(description = "Sucesso", responseCode = "200", content = {
					@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = UsuarioResponseDto.class))) }),
			@ApiResponse(responseCode = "204", description = "Solicitação bem sucedida"),
			@ApiResponse(responseCode = "400", description = "Não autorizado"),
